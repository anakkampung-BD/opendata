        ...
        <ul class="nav" id="side-menu">
            <li class="user-pro">
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?= base_url('user/profile'); ?>" class="text-black"><i class="fa fa-user"></i> My Profile</a>
                    </li>
                    <li>
            ...
            <li class="active">
                <a class="waves-effect waves-light active" href="admin">
            ...
            <li class="">
                <a class="waves-effect waves-light active+" href="#">
                    <i data-icon="O" class="fa fa-cogs"></i> <span class="hide-menu">
                        Pengaturan <span class="fa arrow"></span>
                    </span></a>
                <ul class="nav nav-second-level">
                    <li class="">
                    ...
                    <li class="">
                        <a href="admin/akomodasi"> List Akomodasi </a>
                    </li>
                    <li class="">
                        <a href="admin/tarif"> Tarif Retribusi </a>
                    </li>
                    <li class="">
            ...
            <li class="">
                <a class="waves-effect waves-light active+" href="#">
                    <i data-icon="0" class="fa fa-bus"></i> <span class="hide-menu">
                        Data Check-In <span class="fa arrow"></span>
                    </span></a>
                <ul class="nav nav-second-level">
                    <li class="">
                        <a href="admin/tic"> TIC Entry
                            <span class="label label-rouded label-info pull-right">12</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="admin/duty"> On Duty Entry
            ...
            <li class="">
                <a class="waves-effect waves-light " href="#">
                    <i data-icon="O" class="fa fa-bell"></i> <span class="hide-menu">
                        Persetujuan <span class="notify"><span class="heartbit"></span><span class="point"></span></span>
                        <span class="fa arrow"></span>
                    </span></a>
                <ul class="nav nav-second-level">
                    <li class="">
