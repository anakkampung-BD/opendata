...
class Pidie {
    ...
    tooltip() {
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-tooltip"),
            function(elem) {
    ...
    searchSelectBox() {
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-search-select"),
            function(elem) {
    ...
    telephoneInput() {
        ...
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-telephone-input"),
            function(elem) {
                var dropdownTelephone = document.createElement("div");
                dropdownTelephone.classList.add("pd-telephone-dropdown");
                var dropdownContent = "";
                dropdownContent +=
                    '<div class="pd-telephone-flag"><div class="flag flag-us"></div></div><ul class="pd-telephone-list"></ul>';
                ...
                flagTelephone.forEach(function(res) {
                    itemTelephone +=
                        '<li class="pd-telephone-item" data-dial-code="' +
                        res.phone +
                        '" data-country-code="' +
                        res.id.toLowerCase() +
                        '"><span class="flag flag-' +
                        res.id.toLowerCase() +
                        '"></span> <span class="pd-telephone-name">' +
                        res.name +
                        '</span> <span class="pd-telephone-code">' +
                        res.phone +
                        "</span></li>";
                });
                ...
                Array.prototype.forEach.call(
                    listTelephone.querySelectorAll(".pd-telephone-item"),
                    function(element) {
                        element.onclick = function(e) {
                            ...
                            toggleTelephone
                                ...
                                .setAttribute(
                                    "class",
                                    "flag flag-" + this.getAttribute("data-country-code")
                                );
    ...
    flagSelectBox() {
        ...
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-countries"),
            function(elem) {
                var addCountry = "";
        ...
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-languages"),
            function(elem) {
                var addCountry = "";
        ...
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-currencies"),
            function(elem) {
                var addCountry = "";
        ...
        for (var i = 0; i < flagSelect.length; i++) {
            ...
            for (var j = 1; j < selElmnt.length; j++) {
                ...
                flagArr.innerHTML =
                    '<i class="flag flag-' +
                    selElmnt.options[j].getAttribute("data-value").toLowerCase() +
                    '"></i> <span class="pd-flag-items-item">' +
                ...
                flagArr.addEventListener("click", function(e) {
                    var flagSame = this.parentNode.parentNode.getElementsByTagName(
                        "select"
                    )[0];
                    var flagSibling = this.parentNode.previousSibling;
                    for (var i = 0; i < flagSame.length; i++) {
                        if (
                            flagSame.options[i].innerHTML == this.getAttribute("data-country")
                        ) {
                            flagSame.selectedIndex = i;
                            flagSibling.innerHTML = this.getAttribute("data-country");
                            var flagSase = this.parentNode.getElementsByClassName(
    ...
    toggleSwitch() {
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-toggle-switch"),
            function(elem) {
    ...
    rangeSlider() {
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-range"),
            function(elem) {
    ...
    spinner(options = {}) {
        ...
        Array.prototype.forEach.call(spin, function(elem) {
            ...
            spinItem +=
                ...
                settings.buttonsWidth +
                '" class="pd-spinner-decrement btn ' +
                settings.buttonsClass +
                '">' +
                settings.decrementButton +
                "</button>";
            spinItem += "</div>";
            spinItem +=
                '<input type="text" style="text-align: ' +
                settings.inputAlign +
                '" class="pd-spinner-input form-control"/>';
            spinItem += '<div class="input-group-append">';
            spinItem +=
                '<button type="button" style="width: ' +
                settings.buttonsWidth +
                '" class="pd-spinner-increment btn ' +
                settings.buttonsClass +
                '">' +
                settings.incrementButton +
                "</button>";
            spinItem += "</div>";
        ...
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-spinner-wrap"),
            function(element) {
                var min = parseInt(element.getAttribute("min")) || 0;
                var max =
                    isNaN(element.getAttribute("max")) ||
                    element.getAttribute("max") === "" ?
                    Infinity :
                    parseInt(element.getAttribute("max"));
    ...
    popover() {
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-popover-wrap"),
            function(elem) {
    ...
    tryitLike(editor) {
        ...
        var tinggi =
            ...
            (document.querySelector(".pd-nav").scrollHeight + 8);
        ...
        menurun.addEventListener("click", function(e) {
            e.preventDefault();
            var konten = hasil.contentWindow ?
                hasil.contentWindow :
                hasil.contentDocument.document ?
                hasil.contentDocument.document :
                hasil.contentDocument;
    ...
    passwordValidation() {
        ...
        passValidate.addEventListener("keyup", function() {
            ...
            passInfo +=
                '<p id="pd-password-letter" class="pd-password-invalid">Only one or more <b>lowercase</b> letter</p>';
            passInfo +=
                '<p id="pd-password-capital" class="pd-password-invalid">Only one or more <b>capital (uppercase)</b> letter</p>';
            passInfo +=
                '<p id="pd-password-number" class="pd-password-invalid">Only one or more <b>number</b></p>';
            passInfo +=
                '<p id="pd-password-length" class="pd-password-invalid">Minimum <b>8 characters</b> letter or number</p>';
    ...
    productImage() {
        ...
        for (var i = 0; i < 4; i++) {
            pagiItem +=
                '<img src="' +
                sliderImageProduct
                .getElementsByClassName("pd-product-image-slide")[i].getAttribute("src") +
                '" data-product-image="' +
                i +
                '" width="100" height="80"/>';
        }
        ...
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-product-image-pagination img"),
            function(elem) {
                elem.onclick = function(e) {
                    e.preventDefault();
                    for (var j = 0; j < 4; j++) {
                        sliderImageProduct
                            .getElementsByClassName("pd-product-image-slide")[j].classList.remove("pd-product-image-active");
                    }
                    var no = elem.getAttribute("data-product-image");
                    sliderImageProduct
                        .getElementsByClassName("pd-product-image-slide")[no].classList.add("pd-product-image-active");
                };
            }
        );
        ...
        resultImageProduct.style.backgroundImage =
            "url('" + zoomImageProduct.src + "')";
        resultImageProduct.style.backgroundSize =
            zoomImageProduct.width * 2 + "px " + zoomImageProduct.height * 2 + "px";
        ...
        function moveImage(e) {
            ...
            resultImageProduct.style.backgroundPosition =
    ...
    imageMagnifier(options = {}) {
        ...
        glass.style.backgroundSize =
            img.width * settings.zoom + "px " + img.height * settings.zoom + "px";
        bw = 3;
        ...
        function moveMagnifier(e) {
            ...
            glass.style.backgroundPosition =
                "-" +
                (x * settings.zoom - w + bw) +
                "px -" +
                (y * settings.zoom - h + bw) +
                "px";
        }
    ...
    treeView() {
        ...
        for (i = 0; i < toggler.length; i++) {
            toggler[i].addEventListener("click", function() {
                this.parentElement
                    .querySelector(".pd-tree-child")
                    .classList.toggle("pd-tree-active");
    ...
    imageCompare() {
        ...
        function compareImages(img) {
            ...
            slider.innerHTML =
                '<span class="pd-image-compare-icon">&#10094; &#10095;<span>';
    ...
    quotesSlideshow() {
        ...
        var dotContent = "";
        for (
            var j = 1; j <= quoteSlide.querySelectorAll(".pd-quotes-slide").length; j++
        ) {
            dotContent +=
                '<span class="pd-quotes-dot" data-quote="' + j + '"></span>';
        }
        dotQuotes.innerHTML = dotContent;
        showSlides(slideIndex);
        Array.prototype.forEach.call(
            dotQuotes.querySelectorAll(".pd-quotes-dot"),
            function(elem) {
    ...
    equalHeight(kelas) {
        ...
        Array.prototype.forEach.call(sameHeight, function(elem) {
            (elem.style.height = bagiHeight + "px"), "important";
        });
    }
    ...
    tableOfContents(options = {}) {
        ...
        for (var i = 0; i < headings.length; i++) {
            ...
            links +=
                ...
                headings[i].id +
                '">' +
                toTitleCase(headings[i].innerHTML) +
                "</a>";
            tingkat = newLevel;
        }
        links += "</li></ul>";
        tocPanel.innerHTML =
            '<h4 style="text-align:center;margin-top:0;">Table of Contents</h4>' +
            links;
    ...
    downloadLoading(id) {
        ...
        downloadButton.addEventListener("click", function() {
            ...
            downloadContent +=
                '<h1 class="pd-download-count">' + Number(downloadTime) + "</h1>";
            downloadContent +=
                '<p class="pd-download-loading">Please Wait, Download Loading...</p>';
            downloadContent +=
                '<p class="pd-download-button pd-hide"><a href="' +
                downloadLink +
                '" class="pd-button pd-button-primary" style="text-decoration:none">Download Again</a><br/><button style="margin-top:10px" class="pd-button pd-button-danger pd-download-close">Cancel</button></p>';
            downloadContent += "</div>";
            ...
            setInterval(function() {
                ...
                if (jumlahWaktu === 0) {
                    ...
                    downloadBody
                        .querySelector(".pd-download-loading")
                        .classList.add("pd-hide");
                    downloadBody
                        .querySelector(".pd-download-button")
                        .classList.remove("pd-hide");
                }
            }, 1000);
            downloadBody
                .querySelector(".pd-download-close")
    ...
    demoPage(id) {
        ...
        pageDemo.addEventListener("click", function() {
            ...
            contentDemo +=
                '<h1 class="pd-demo-title">' +
                pageDemo.getAttribute("data-demo-title") +
                "</h1>";
            contentDemo += "</div>";
            ...
            contentDemo +=
                '<button class="pd-demo-close pd-button pd-button-outline-danger">&times</button>';
            contentDemo += "</div>";
            contentDemo += "</div></div>";
            contentDemo +=
                '<iframe src="' +
                pageDemo.getAttribute("data-demo-link") +
                '" class="pd-demo-frame"></iframe>';
            ...
            createDemo.querySelector(".pd-demo-frame").style.height =
                tinggi - 80 + "px";
            createDemo
                .querySelector(".pd-demo-close")
                .addEventListener("click", function() {
    ...
    galleryLightbox() {
        ...
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-gallery"),
            function(item) {
        ...
        function lightboxOpen(src, lightbox) {
            ...
            var lightboxContent = "";
            lightboxContent +=
                '<div class="pd-lightbox-nav"><span class="pd-lightbox-close">&times</span></div>';
            if (datalightbox != 0) {
            ...
            for (var i = Number(datalightbox); i < Number(datalightbox) + 7; i++) {
                if (document.getElementsByClassName("pd-gallery")[i]) {
                    ...
                    lightboxThumbnailImage.setAttribute(
                        "src",
                        document.getElementsByClassName("pd-gallery")[i].getAttribute("src")
                    );
                    lightboxThumbnailImage.setAttribute(
                        "data-lightbox-thumbnail-item",
                        document
                        .getElementsByClassName("pd-gallery")[i].getAttribute("data-lightbox-item")
                    );
                    ...
                    lightboxThumbnailImage.onclick = function(e) {
                        ...
                        var datathumb = e.target.getAttribute(
                            "data-lightbox-thumbnail-item"
                        );
                        datalightbox = Number(datathumb);
                        datasrc = document
                            .getElementsByClassName("pd-gallery")[datalightbox].getAttribute("src");
                        lightboxOpen(datasrc, datalightbox);
                    };
                }
            }
            lightboxPage
                .querySelector(".pd-lightbox-close")
                .addEventListener("click", function() {
                    lightboxPage.classList.add("pd-hide");
                    document.body.classList.remove("pd-lightbox-scrollbar");
                });
            if (datalightbox != 0) {
                lightboxPage
                    .querySelector(".pd-lightbox-prev")
                    .addEventListener("click", function() {
                        lightboxPage.classList.add("pd-hide");
                        document.body.classList.remove("pd-lightbox-scrollbar");
            ...
            if (datalightbox != Number(lightLength)) {
                lightboxPage
                    .querySelector(".pd-lightbox-next")
                    .addEventListener("click", function() {
                        lightboxPage.classList.add("pd-hide");
                        document.body.classList.remove("pd-lightbox-scrollbar");
    ...
    modalDialog() {
        Array.prototype.forEach.call(
            document.querySelectorAll(".pd-modal-open"),
            function(elem) {
                elem.onclick = function() {
                    ...
                    var modalOpen = document.getElementById(
    ...
    titleLink() {
        var titleLink = document.querySelector(
            ".pd-titlelink-input input[type=text]"
        );
        var urlLink = document.querySelector(
            ".pd-titlelink-output input[type=text]"
        );
        var separator = "-";
        var special = {
            ą: "a",
    ...
    generatePassword() {
        var generatePasswordInput = document.querySelector(
            ".pd-generate-password input"
        );
        var generatePasswordButton = document.querySelector(
            ".pd-generate-password button"
        );
        generatePasswordButton.addEventListener("click", function() {
            var generatePasswordChar =
                generatePasswordInput.getAttribute("data-generate-password") || "";
            var generatePasswordMax =
                generatePasswordInput.getAttribute("data-generate-max") || "";
            var characters = "",
                result = "";
    ...
    headerSlide() {
        ...
        for (var i = 0; i < slideLength; i++) {
            ...
            slidePagi +=
                '<a href="#" class="pd-slide-pagi" data-slide="' + i + '"></a>';
        }
    ...
    listGrid() {
        ...
        listButton.addEventListener("click", function(e) {
            ...
            for (var i = 1; i <= listGridFilter.children.length; i++) {
                vm.removeClass(
                    document.querySelector(".pd-list-grid:nth-child(" + i + ")"),
                    "pd-col-md-4"
                );
            }
        });
    ...
    searchFilter() {
        var verticalSearch = document.querySelector(
            ".pd-vertical-filter input[type=search]"
        );
        var horizontalSearch = document.querySelector(
            ".pd-horizontal-filter input[type=search]"
        );
        ...
        function searchItem(filter) {
            ...
            for (var i = 0; i < productItem.length; i++) {
                var titleItem = productItem[i].getElementsByClassName(
                    "pd-card-title"
                )[0];
    ...
    tab() {
        ...
        function resetTabs() {
            Array.prototype.forEach.call(
                wrapTabs.querySelectorAll("." + contentTabs),
                function(item) {
                    item.style.display = "none";
                }
            );
            Array.prototype.forEach.call(
                wrapTabs.querySelectorAll("." + titleTabs),
                function(item) {
        ...
        function openTabs(n) {
            resetTabs();
            var i = checkTabs(n);
            wrapTabs.querySelectorAll("." + titleTabs)[i].className +=
                " " + activeTabs;
    ...
    collapseAccordion() {
        ...
        elemAccordion.addEventListener("click", function(e) {
            ...
            if (
                nextAccordion.style.height === "0px" ||
                nextAccordion.style.height === ""
            ) {
        ...
        function closeAccordion() {
            Array.prototype.forEach.call(
                elemAccordion.querySelectorAll(".pd-accordion-body"),
                function(item) {
                    item.style.height = 0;
                }
            );
    ...
    sortFilter() {
        ...
        document.querySelector(".pd-filter-total").innerHTML =
            "Total items: " + sortItem.length;
        sortValue.addEventListener(
            "change",
            function() {
                var pindah = true,
                    harusPindah,
    ...
    paginationFilter() {
        ...
        function pageMove(index) {
            ...
            Array.prototype.forEach.call(
                pagePagi.getElementsByClassName("pd-pagination-link"),
                function(item) {
                    item.classList.remove("active");
                }
            );
            pagePagi
                .getElementsByClassName("pd-pagination-link")[current].classList.add("active");
        ...
        function pagi() {
            var pageContent = "";
            pageContent +=
                '<a href="#" class="pd-pagination-item pd-pagination-first" data-pagitem="first">&laquo;</a>';
            pageContent +=
                '<a href="#" class="pd-pagination-item pd-pagination-prev" data-pagitem="prev">&#10094;</a>';
            for (var i = 1; i <= pageBagi.toFixed(0); i++) {
                if (i == current) {
                    pageContent +=
                        '<a href="#" class="pd-pagination-item pd-pagination-link active" data-pagitem="' +
                        i +
                        '">' +
                        i +
                        "</a>";
                ...
                if (i != current) {
                    pageContent +=
                        '<a href="#" class="pd-pagination-item pd-pagination-link" data-pagitem="' +
                        i +
                        '">' +
                        i +
                        "</a>";
            ...
            pageContent +=
                '<a href="#" class="pd-pagination-item pd-pagination-next" data-pagitem="next">&#10095;</a>';
            pageContent +=
                '<a href="#" class="pd-pagination-item pd-pagination-last" data-pagitem="last">&raquo;</a>';
            pageFilter.innerHTML =
                '<div class="pd-pagination">' + pageContent + "</div>";
        }
    }
}